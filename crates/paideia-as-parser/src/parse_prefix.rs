...
impl<'tok, 'ast, 'snk> Parser<'tok, 'ast, 'snk> {
    ...
    ///
    /// Prefix operators include: `!`, `-`, `&`, `*` (unary dereference),
    /// and `$` (LinearMark for linear consume).
    ///
    /// Returns ExprPrefix node with operand fully parsed at the correct binding power.
