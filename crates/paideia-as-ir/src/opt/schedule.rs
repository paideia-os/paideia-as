...
fn classify_mnemonic(mnemonic: Mnemonic) -> InstructionClass {
    match mnemonic {
        ...
        Mnemonic::Add | Mnemonic::Sub | Mnemonic::Cmp | Mnemonic::CmpSized { .. } | Mnemonic::Test | Mnemonic::Adc { .. } | Mnemonic::Sbb { .. } | Mnemonic::Popcnt { .. } | Mnemonic::Crc32 { .. } | Mnemonic::Bsf { .. } | Mnemonic::Bsr { .. } | Mnemonic::Tzcnt { .. } => InstructionClass::AluReg,
