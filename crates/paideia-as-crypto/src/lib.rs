...
//!
//! 1. Traits are the primary API. Concrete impls (e.g. `Argon2id`) live
//!    behind the trait so `stdlib_lowering` recipes can be swapped for
//!    a paideia-native implementation without touching callers.
