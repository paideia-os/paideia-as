...
pub mod enum_layout_populator;
pub mod enum_registry;
pub mod enum_variant_payload_populator;
...
pub use enum_layout_populator::finalise_enum_layouts;
pub use enum_registry::{EnumRegistry, build_enum_registry};
pub use enum_variant_payload_populator::finalise_enum_variant_payloads;
pub use struct_registry::{StructRegistry, build_struct_registry};
